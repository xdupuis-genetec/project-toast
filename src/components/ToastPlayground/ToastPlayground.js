...
function ToastPlayground() {
  ...
  const [isToastOpened, setIsToastOpened] = React.useState(false);
  ...
  return (
    <div className={styles.wrapper}>
      ...
      {isToastOpened && 
        <Toast variant={variant} dismiss={() => setIsToastOpened(false)} >
          {message}
        </Toast>
      }
      ...
      <div className={styles.controlsWrapper}>
        ...
        <div className={styles.row}>
          ...
          <div
            className={`${styles.inputWrapper} ${styles.radioWrapper}`}
          >
            <Button onClick={() => setIsToastOpened(true)}>Pop Toast!</Button>
          </div>
        </div>
      </div>
    </div>
